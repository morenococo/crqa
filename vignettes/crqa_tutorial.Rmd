...
comparison, and line-statistic collection are merged into a single pass
that never materialises the N×N distance matrix — and adds OpenMP
...
- **`crqa v2.0.7 (legacy)`** hits the 30 s wall and runs out of memory
  at N ≈ 12 k.
...
- **AccRQA 1.0.1 (CPU, Adámek et al. 2026)** is a high-performance
  ...
  parameter optimisation, or visualisation — those remain exclusive
  to crqa.
